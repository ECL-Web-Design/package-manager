...
import {FieldType, FieldValueTypes, OptionList} from "types/Form.types.ts"
import {computed, defineAsyncComponent, ref, watch, watchEffect} from "vue"
import {ValidityReturn, ValidationStatus} from "types/validation.types.ts"
...
const props = defineProps<{
    ...
    optionsList?: OptionList<ValueType>,
    useOptionIcons?: boolean,
    validateCallback?: (value: ValueType) => ValidityReturn
}>()
